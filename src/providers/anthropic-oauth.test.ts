...
describe("buildAuthorizeUrl", () => {
  it("uses the Claude Code subscription scope set (extracted from the CC bundle)", () => {
    // CLAUDE_AI_OAUTH_SCOPES from the Claude Code bundle — the subscription set.
    // No org:create_api_key (console/API mode only).
